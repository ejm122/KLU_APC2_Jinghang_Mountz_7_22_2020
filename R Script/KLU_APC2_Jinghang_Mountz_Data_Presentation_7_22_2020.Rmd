...
mdl_memory_learning_fwhm <- lm(memory_learning ~ FaceName_PostScanAccuracy + Left_Hippocampus_FWHM + Right_Hippocampus_FWHM +Left_DLPFC_FWHM + Right_DLPFC_FWHM+ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_CODE, data = data)
...
mdl_memory_retrieval_fwhm <- lm(memory_retrieval ~ FaceName_PostScanAccuracy + Left_Hippocampus_FWHM + Right_Hippocampus_FWHM +Left_DLPFC_FWHM + Right_DLPFC_FWHM+ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_CODE, data = data)
...
``` {r visiospatial_fwhm, echo = FALSE}

mdl_visiospatial_fwhm <- lm(visiospatial ~ FaceName_PostScanAccuracy + Left_Hippocampus_FWHM + Right_Hippocampus_FWHM +Left_DLPFC_FWHM + Right_DLPFC_FWHM+ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_CODE, data = data)

visiospatial_fwhm_rsquared <- summary(mdl_visiospatial_fwhm)$r.squared
visiospatial_fwhm_fstat <- summary(mdl_visiospatial_fwhm)$fstatistic[1]
visiospatial_fwhm_df1 <- summary(mdl_visiospatial_fwhm)$fstatistic[2]
visiospatial_fwhm_df2 <- summary(mdl_visiospatial_fwhm)$fstatistic[3]
visiospatial_fwhm_pval <- lmp(mdl_visiospatial_fwhm)
```

``` {r language_fwhm, echo = FALSE}

mdl_language_fwhm <- lm(language ~FaceName_PostScanAccuracy + Left_Hippocampus_FWHM + Right_Hippocampus_FWHM +Left_DLPFC_FWHM + Right_DLPFC_FWHM+ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_CODE, data = data)
...
mdl_executive_attention_fwhm <- lm(executive_attention ~ FaceName_PostScanAccuracy+ Left_Hippocampus_FWHM + Right_Hippocampus_FWHM +Left_DLPFC_FWHM + Right_DLPFC_FWHM+ Age_CurrentVisit+Sex_cat+Race_cat+Education_cat+FDG_SUVR_GTM_FS_Global+PiB_STATUS_CODE+APOE_CODE, data = data)
...
**Visiospatial Domain**
<div style="margin-bottom:100px;">
``` {r visiospatial_fwhm_data, echo = FALSE}
visiospatial_fwhm_data <- data.frame(Variable = c(paste("F( ", visiospatial_fwhm_df1, ",", visiospatial_fwhm_df2,")"),"R^2","p-value"),
                               Value = c(visiospatial_fwhm_fstat, visiospatial_fwhm_rsquared, visiospatial_fwhm_pval))

kable(visiospatial_fwhm_data, caption = "Visiospatial Summary", digits = 3) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
```

``` {r visiospatial_fwhm_coefficients, echo = FALSE}
tab_model(mdl_visiospatial_fwhm, dv.labels = "Visiospatial",
          pred.labels = c("Intercept","FaceName_PostScanAccuracy", "Left_Hippocampus_FWHM","Right_Hippocampus_FWHM", "Left_DLPFC_FWHM", "Right_DLPFC_FWHM", "Age at Visit", "Sex",  "Race","Education (years)", "FDG Global", "PiB Global Status", "APOE Status"), show.r2 = FALSE, show.ci = FALSE)
```
</div>
