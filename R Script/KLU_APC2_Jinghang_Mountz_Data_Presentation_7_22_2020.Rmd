...
``` {r activation_left_hippocampus_coefficients, echo = FALSE}
tab_model(mdl_activation_left_hippocampus, dv.labels = "Left Hippocampus Activation",
          pred.labels = c("Intercept", "Age at Visit", "Sex",  "Race","Education (years)", "FDG Global", "PiB Global Status", "APOE Status"), show.r2 = FALSE, show.ci = FALSE)
```
</div>

**Right Hippocampus Activation**
<div style="margin-bottom:100px;">
...
``` {r activation_right_hippocampus_coefficients, echo = FALSE}
tab_model(mdl_activation_right_hippocampus, dv.labels = "Right Hippocampus Activation",
          pred.labels = c("Intercept", "Age at Visit", "Sex",  "Race","Education (years)", "FDG Global", "PiB Global Status", "APOE Status"), show.r2 = FALSE, show.ci = FALSE)
```
</div>
